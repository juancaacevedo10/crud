  ...
  return (
    <div className='container mt-5'>
      ...
      <div className='row'>
        ...
        <div className='col-4'>
          <h4 className='text-center'>{editMode ?'Modificar tarea': 'Agreagar tareas'}</h4>
          <form onSubmit={editMode ? saveTask : addTask}>
          {
            ...
            value={task}
              />
            <button type='submit' className={editMode ? 'btn btn-warning btn-block':'btn btn-dark btn-block'}>{editMode ? 'Guardar':'Agregar'}</button>
          </form>
        </div>
      </div>
    </div>
